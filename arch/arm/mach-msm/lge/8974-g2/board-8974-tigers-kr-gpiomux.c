...
#endif
/*  LGE_CHANGE_S, [NFC][yunjeong.jang@lge.com], 2014-04-15, NFC Bring up */
...
#endif
/*  LGE_CHANGE_E, [NFC][yunjeong.jang@lge.com], 2014-04-15, NFC Bring up */
#ifdef CONFIG_MACH_LGE
	{
...
/* LGE_CHANGE_S, [NFC][yunjeong.jang@lge.com], 2014-04-15 */
#if defined(CONFIG_LGE_NFC) || defined(CONFIG_NFC_BCM2079X) || defined(CONFIG_LGE_NFC_PN547_C2)
#else
	{
		.gpio = 92, /* CAM2_RST_N */
...
#endif
/* LGE_CHANGE_E, [NFC][yunjeong.jang@lge.com], 2014-04-15 */
